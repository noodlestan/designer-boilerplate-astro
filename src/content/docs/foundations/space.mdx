...
<ShowDecisionCard store={store} d="Space Unit" size="m" viz="square" />
...
<ShowDecisionCard store={store} d="Sizing Space Scale" size="m" viz="square" />
...
<ShowDecisionCard store={store} d="Layout Space Scale" size="s" viz="bar-h" />
...
<ShowDecisionCard store={store} d="Layout Rhythm Scale" size="m" viz="bar-v" />
